...
--
-- Host: localhost
-- Generation Time: Oct 04, 2013 at 07:44 PM
...
--
-- Database: `olhemaisumavez`
--

-- --------------------------------------------------------

--
-- Table structure for table `omuz_assets`
--

CREATE TABLE `omuz_assets` (
...
--
-- Dumping data for table `omuz_assets`
--

INSERT INTO `omuz_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(37, 1, 69, 70, 1, 'com_loja', 'loja', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `omuz_associations`
--

CREATE TABLE `omuz_associations` (
...
--
-- Table structure for table `omuz_banners`
--

CREATE TABLE `omuz_banners` (
...
--
-- Table structure for table `omuz_banner_clients`
--

CREATE TABLE `omuz_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `omuz_banner_tracks`
--

CREATE TABLE `omuz_banner_tracks` (
...
--
-- Table structure for table `omuz_categories`
--

CREATE TABLE `omuz_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `omuz_categories`
--

INSERT INTO `omuz_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `omuz_contact_details`
--

CREATE TABLE `omuz_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `omuz_content`
--

CREATE TABLE `omuz_content` (
...
--
-- Table structure for table `omuz_contentitem_tag_map`
--

CREATE TABLE `omuz_contentitem_tag_map` (
...
--
-- Table structure for table `omuz_content_frontpage`
--

CREATE TABLE `omuz_content_frontpage` (
...
--
-- Table structure for table `omuz_content_rating`
--

CREATE TABLE `omuz_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `omuz_content_types`
--

CREATE TABLE `omuz_content_types` (
...
--
-- Dumping data for table `omuz_content_types`
--

INSERT INTO `omuz_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`) VALUES
...
--
-- Table structure for table `omuz_core_log_searches`
--

CREATE TABLE `omuz_core_log_searches` (
...
--
-- Table structure for table `omuz_extensions`
--

CREATE TABLE `omuz_extensions` (
...
--
-- Dumping data for table `omuz_extensions`
--

INSERT INTO `omuz_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(433, 'plg_user_profile', 'plugin', 'profile', 'user', 0, 1, 1, 0, '{"name":"plg_user_profile","type":"plugin","creationDate":"January 2008","author":"Joomla! Project","copyright":"(C) 2005 - 2013 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.0.0","description":"PLG_USER_PROFILE_XML_DESCRIPTION","group":""}', '{"register-require_address1":"2","register-require_address2":"0","register-require_city":"2","register-require_region":"2","register-require_country":"0","register-require_postal_code":"2","register-require_phone":"2","register-require_website":"0","register-require_favoritebook":"0","register-require_aboutme":"0","register-require_tos":"0","register_tos_article":"","register-require_dob":"0","profile-require_address1":"2","profile-require_address2":"0","profile-require_city":"2","profile-require_region":"2","profile-require_country":"0","profile-require_postal_code":"2","profile-require_phone":"2","profile-require_website":"0","profile-require_favoritebook":"0","profile-require_aboutme":"0","profile-require_dob":"1"}', '', '', 5, '2013-10-01 12:27:30', 0, 0),
...
(10000, 'PortugusBrasil', 'language', 'pt-BR', '', 0, 1, 0, 0, '{"name":"Portugu\\u00eas(Brasil)","type":"language","creationDate":"2013-01-29","author":"Joomla Brasil","copyright":"Copyright 2005 - 2013 Open Source Matters. Todos os Direitos Reservados. Copyright Translation 2005 - 2013 Joomla Brasil. Todos os Direitos Reservados.","authorEmail":"traducao@joomla.com.br","authorUrl":"www.joomla.com.br","version":"3.0.3.1","description":"\\n\\t\\t\\t\\tArquivos de Idioma em Portugu\\u00eas Brasileiro para o CMS Joomla! 3.0<br\\/>\\n\\t\\t\\t\\tCopyright 2005 - 2013 Open Source Matters. Todos os Direitos Reservados. Copyright Translation 2005 - 2013 Joomla Brasil. Todos os Direitos Reservados.<br\\/>\\n\\t\\t\\t\\tDe acordo com termo de licenciamento de <a href=\\"http:\\/\\/www.opensourcematters.org\\" target=\\"_blank\\">OpenSourceMatters<\\/a> e <a href=\\"http:\\/\\/www.joomla.org\\" target=\\"_blank\\">Joomla!<\\/a> todos os arquivos de idioma devem ser licenciados sob a <a href=\\"http:\\/\\/www.gnu.org\\/licenses\\/gpl-2.0.html\\" target=\\"_blank\\"> licen\\u00e7a GNU\\/GPL (v.2.0)<\\/a>. Esta tradu\\u00e7\\u00e3o est\\u00e1 licenciada sob esta licen\\u00e7a. Se voc\\u00ea encontrar algum erro de digita\\u00e7\\u00e3o, tradu\\u00e7\\u00f5es incorretas ou se deseja sugerir melhorias, entre em contato com o <a href=\\"mailto:traducao@joomla.com.br\\">coordenador<\\/a> da tradu\\u00e7\\u00e3o.\\n\\t\\t\\t\\t\\n\\t","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'PortugusBrasil', 'language', 'pt-BR', '', 1, 1, 0, 0, '{"name":"Portugu\\u00eas(Brasil)","type":"language","creationDate":"2013-01-29","author":"Joomla Brasil","copyright":"Copyright 2005 - 2013 Open Source Matters. Todos os Direitos Reservados. Copyright Translation 2005 - 2013 Joomla Brasil. Todos os Direitos Reservados.","authorEmail":"traducao@joomla.com.br","authorUrl":"www.joomla.com.br","version":"3.0.3.1","description":"\\n\\t\\t\\t\\tArquivos de Idioma em Portugu\\u00eas Brasileiro para o CMS Joomla! 3.0<br\\/>\\n\\t\\t\\t\\tCopyright 2005 - 2013 Open Source Matters. Todos os Direitos Reservados. Copyright Translation 2005 - 2013 Joomla Brasil. Todos os Direitos Reservados.<br\\/>\\n\\t\\t\\t\\tDe acordo com termo de licenciamento de <a href=\\"http:\\/\\/www.opensourcematters.org\\" target=\\"_blank\\">OpenSourceMatters<\\/a> e <a href=\\"http:\\/\\/www.joomla.org\\" target=\\"_blank\\">Joomla!<\\/a> todos os arquivos de idioma devem ser licenciados sob a <a href=\\"http:\\/\\/www.gnu.org\\/licenses\\/gpl-2.0.html\\" target=\\"_blank\\"> licen\\u00e7a GNU\\/GPL (v.2.0)<\\/a>. Esta tradu\\u00e7\\u00e3o est\\u00e1 licenciada sob esta licen\\u00e7a. Se voc\\u00ea encontrar algum erro de digita\\u00e7\\u00e3o, tradu\\u00e7\\u00f5es incorretas ou se deseja sugerir melhorias, entre em contato com o <a href=\\"mailto:traducao@joomla.com.br\\">coordenador<\\/a> da tradu\\u00e7\\u00e3o.\\n\\t\\t\\t\\t\\n\\t","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'TinyMCE Idioma Português (Brasil)', 'file', 'TinyMCE_pt-BR', '', 0, 1, 0, 0, '{"name":"TinyMCE Idioma Portugu\\u00eas (Brasil)","type":"file","creationDate":"03 Set 2012","author":"Ponto Mega","copyright":"(C) 2005-2013 Brazilian Translation Team","authorEmail":"traducao@pontomega.com.br","authorUrl":"","version":"3.5.1","description":"\\t\\t\\n\\t\\t<h3><strong>Instala\\u00e7\\u00e3o do pacote de idioma Portugu\\u00eas (Brasil) para o editor TinyMCE 3.5.1 foi conclu\\u00eddo com sucesso.<\\/strong><\\/h3><br\\/>\\n\\t\\tN\\u00e3o se esque\\u00e7a de selecionar o idioma para PT <a href=\\"index.php?option=com_plugins&view=plugins&filter_search=TinyMCE\\"><strong>Gerenciamento de plug-in TinyMCE<\\/strong><\\/a><br \\/>\\n\\t\\tSe voc\\u00ea usar a detec\\u00e7\\u00e3o autom\\u00e1tica, certifique-se de que est\\u00e3o instalados os pacotes de idiomas diferentes para TinyMCE correspondentes aos instalado para o Joomla !<\\/div>\\t<br\\/><br\\/>\\t\\n\\t\\t\\n\\t","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 'pt-BR', 'package', 'pkg_pt-BR', '', 0, 1, 1, 0, '{"name":"Portuguese Brazil Language Pack","type":"package","creationDate":"Janeiro 2013","author":"Joomla Brasil","copyright":"","authorEmail":"traducao@joomla.com.br","authorUrl":"www.joomla.com.br","version":"3.0.3.1","description":"\\n\\t\\t\\t\\t<h3><strong>Instala\\u00e7\\u00e3o do pacote de idioma Portugu\\u00eas (Brasil) para o CMS Joomla! 3.0 e o editor TinyMCE 3.5.1 foram conclu\\u00eddos com sucesso.<\\/strong><\\/h3><br\\/>\\n\\t\\t\\t\\tCopyright 2005 - 2013 Open Source Matters. Todos os Direitos Reservados. Copyright Translation 2005 - 2013 Joomla Brasil. Todos os Direitos Reservados.<br\\/>\\n\\t\\t\\t\\tDe acordo com termo de licenciamento de <a href=\\"http:\\/\\/www.opensourcematters.org\\" target=\\"_blank\\">OpenSourceMatters<\\/a> e <a href=\\"http:\\/\\/www.joomla.org\\" target=\\"_blank\\">Joomla!<\\/a> todos os arquivos de idioma devem ser licenciados sob a <a href=\\"http:\\/\\/www.gnu.org\\/licenses\\/gpl-2.0.html\\" target=\\"_blank\\"> licen\\u00e7a GNU\\/GPL (v.2.0)<\\/a>. Esta tradu\\u00e7\\u00e3o est\\u00e1 licenciada sob esta licen\\u00e7a. Se voc\\u00ea encontrar algum erro de digita\\u00e7\\u00e3o, tradu\\u00e7\\u00f5es incorretas ou se deseja sugerir melhorias, entre em contato com o <a href=\\"mailto:traducao@joomla.com.br\\"><strong>coordenador<\\/strong><\\/a> da tradu\\u00e7\\u00e3o.\\n\\t\\t\\t\\t\\n\\t\\t\\t\\tN\\u00e3o se esque\\u00e7a de selecionar o idioma para PT <a href=\\"index.php?option=com_plugins&view=plugins&filter_search=TinyMCE\\"><strong>Gerenciamento de plug-in TinyMCE<\\/strong><\\/a><br \\/>\\n\\t\\t\\t\\tSe voc\\u00ea usar a detec\\u00e7\\u00e3o autom\\u00e1tica, certifique-se de que est\\u00e3o instalados os pacotes de idiomas diferentes para TinyMCE correspondentes aos instalado para o Joomla !<\\/div>\\t<br\\/><br\\/>\\n\\t\\t\\t\\t\\n\\t","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10004, 'TemplatePadrao-Olhemaisumavez', 'template', 'templatepadrao-olhemaisumavez', '', 0, 1, 1, 0, '{"name":"Template Padrao - Olhe mais uma vez","type":"template","creationDate":"2013-09-27","author":"PROIZ","copyright":"Copyright \\u00a9 proiz.com","authorEmail":"luiz@proiz.com.br","authorUrl":"http:\\/\\/www.proiz.com.br","version":"1.0.0","description":"\\n\\t\\tTemplate padr\\u00e3o utilizado no site Olhe mais uma vez.\\n\\t","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10006, 'loja', 'component', 'com_loja', '', 1, 1, 0, 0, '{"name":"Loja!","type":"component","creationDate":"Set 2013","author":"Luiz Garcia","copyright":"Copyright Info","authorEmail":"luiz@proiz.com.br","authorUrl":"http:\\/\\/www.proiz.com.br","version":"0.0.1","description":"Componente para gerenciamento das vendas do site olhe mais uma vez.","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_finder_filters`
--

CREATE TABLE `omuz_finder_filters` (
...
--
-- Table structure for table `omuz_finder_links`
--

CREATE TABLE `omuz_finder_links` (
...
--
-- Table structure for table `omuz_finder_links_terms0`
--

CREATE TABLE `omuz_finder_links_terms0` (
...
--
-- Table structure for table `omuz_finder_links_terms1`
--

CREATE TABLE `omuz_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_terms2`
--

CREATE TABLE `omuz_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_terms3`
--

CREATE TABLE `omuz_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_terms4`
--

CREATE TABLE `omuz_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_terms5`
--

CREATE TABLE `omuz_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_terms6`
--

CREATE TABLE `omuz_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_terms7`
--

CREATE TABLE `omuz_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_terms8`
--

CREATE TABLE `omuz_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_terms9`
--

CREATE TABLE `omuz_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_termsa`
--

CREATE TABLE `omuz_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_termsb`
--

CREATE TABLE `omuz_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_termsc`
--

CREATE TABLE `omuz_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_termsd`
--

CREATE TABLE `omuz_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_termse`
--

CREATE TABLE `omuz_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_links_termsf`
--

CREATE TABLE `omuz_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `omuz_finder_taxonomy`
--

CREATE TABLE `omuz_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `omuz_finder_taxonomy`
--

INSERT INTO `omuz_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_finder_taxonomy_map`
--

CREATE TABLE `omuz_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `omuz_finder_terms`
--

CREATE TABLE `omuz_finder_terms` (
...
--
-- Table structure for table `omuz_finder_terms_common`
--

CREATE TABLE `omuz_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `omuz_finder_terms_common`
--

INSERT INTO `omuz_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `omuz_finder_tokens`
--

CREATE TABLE `omuz_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `omuz_finder_tokens_aggregate`
--

CREATE TABLE `omuz_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `omuz_finder_types`
--

CREATE TABLE `omuz_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `omuz_languages`
--

CREATE TABLE `omuz_languages` (
...
--
-- Dumping data for table `omuz_languages`
--

INSERT INTO `omuz_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_loja_autores`
--

CREATE TABLE `omuz_loja_autores` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `omuz_loja_autores`
--

INSERT INTO `omuz_loja_autores` (`id`, `nomecompleto`, `sobre`, `email`, `telefone`) VALUES
(1, 'Moacir J. Rauber', 'cursus et, gravida quis nisl. Vestibulum rhoncus libero quis hendrerit euismod. Nulla hendrerit justo nec sem rhoncus sodales. Nam auctor faucibus erat. Phasellus consectetur.', 'moacir@gmail.com', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_loja_clientes`
--

CREATE TABLE `omuz_loja_clientes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `omuz_loja_clientes`
--

INSERT INTO `omuz_loja_clientes` (`id`, `nome_completo`, `username`, `cpf`, `telefone`, `email`, `senha`, `cep`, `endereco`, `numero`, `bairro`, `cidade`, `estado`, `dataregistro`, `id_joomla`) VALUES
(3, 'Luiz Fernando', 'luiz', '05987854938', '(045) 9923-9', 'luiz@proiz.com.br', 'aaa', '85901-090', 'Rua Chile', 108, 'Centro', 'Toledo', 'PR', '2013-10-02 14:55:59', 8),
(4, 'Teste', 'teste', '12345678999', '(045) 2254-5878', 'teste@proiz.comb.br', 'teste', '85901-090', 'Rua Chile', 108, 'Centro', 'Toledo', 'PR', '2013-10-03 15:03:22', 9),
(6, 'teste', 'teste', '11111111111', '(045) 2215-4878', 'testE@gmai.com', 'luiz', '85901-090', 'Rua Chile', 108, 'Centro', 'Toledo', 'PR', '2013-10-04 08:59:17', 11),
(7, 'novo 2', 'luiz', '12345678979', '(045) 9923-9093', 'teste2@gmail.com', 'luiz', '85910-105', 'Rua Vereador José Pedro Brum', 42, 'Conjunto Cohapar', 'Toledo', 'PR', '2013-10-03 22:03:33', 13);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_loja_editoras`
--

CREATE TABLE `omuz_loja_editoras` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `omuz_loja_editoras`
--

INSERT INTO `omuz_loja_editoras` (`id`, `nome`, `telefone`, `endereco`, `cidade`, `estado`, `descricao`) VALUES
(1, 'Editora', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_loja_itens_pedido`
--

CREATE TABLE `omuz_loja_itens_pedido` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_loja_item_pedido_loja_pedido1_idx` (`id_pedido`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `omuz_loja_itens_pedido`
--

INSERT INTO `omuz_loja_itens_pedido` (`id`, `produto_quantidade`, `produto_nome`, `produto_codigo`, `produto_preco`, `id_pedido`) VALUES
(1, 1, 'Olhe mais uma vez - Em cada situação novas oportunidades\n', '1', 25.00, 2);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_loja_livros`
--

CREATE TABLE `omuz_loja_livros` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `titulo` varchar(200) NOT NULL,
  `sinopse` text,
  `isbn` int(11) DEFAULT NULL,
  `ano` int(11) DEFAULT NULL,
  `edicao` varchar(45) DEFAULT NULL COMMENT '	',
  `id_editora` int(11) DEFAULT NULL,
  `valor` double DEFAULT NULL,
  `fretegratis` char(1) DEFAULT '0',
  `imagem_capa` varchar(145) DEFAULT NULL,
  `paginas` int(11) DEFAULT NULL,
  `estoque` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_olhemaisumavez_livros_olhemaisumavez_editoras_idx` (`id_editora`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `omuz_loja_livros`
--

INSERT INTO `omuz_loja_livros` (`id`, `titulo`, `sinopse`, `isbn`, `ano`, `edicao`, `id_editora`, `valor`, `fretegratis`, `imagem_capa`, `paginas`, `estoque`) VALUES
(1, 'Olhe mais uma vez - Em cada situação novas oportunidades\n', 'orem ipsum dolor sit amet, consectetur adipiscing elit. Proin cursus, elit vitae fermentum hendrerit, neque erat fringilla nibh, vel sodales sem diam nec nunc. Donec mattis blandit metus ut volutpat. Quisque orci lectus, sodales at cursus et, gravida quis nisl. Vestibulum rhoncus libero quis hendrerit euismod. Nulla hendrerit justo nec sem rhoncus sodales. Nam auctor faucibus erat. Phasellus consectetur', 12345678, 2010, '1ª Edição', 1, 25, '0', NULL, 280, 50);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_loja_livros_autores`
--

CREATE TABLE `omuz_loja_livros_autores` (
  `id_livro` int(11) NOT NULL,
  `id_autor` int(11) NOT NULL,
  PRIMARY KEY (`id_livro`,`id_autor`),
  KEY `fk_olhemaisumavez_livros_has_olhemaisumavez_autores_olhemai_idx` (`id_autor`),
  KEY `fk_olhemaisumavez_livros_has_olhemaisumavez_autores_olhemai_idx1` (`id_livro`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `omuz_loja_pedidos`
--

CREATE TABLE `omuz_loja_pedidos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `valor_frete` decimal(5,2) DEFAULT NULL,
  `valor_pedido` decimal(5,2) DEFAULT NULL,
  `status` varchar(45) DEFAULT NULL,
  `valor_itens` decimal(5,2) DEFAULT NULL,
  `data_criacao` datetime DEFAULT NULL,
  `cep_entrega` varchar(12) DEFAULT NULL,
  `endereco_entrega` varchar(150) DEFAULT NULL,
  `numero_entrega` int(11) DEFAULT NULL,
  `bairro_entrega` varchar(155) DEFAULT NULL,
  `cidade_entrega` varchar(145) DEFAULT NULL,
  `estado_entrega` varchar(2) DEFAULT NULL,
  `id_cliente` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_loja_pedido_loja_clientes1_idx` (`id_cliente`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3 ;

--
-- Dumping data for table `omuz_loja_pedidos`
--

INSERT INTO `omuz_loja_pedidos` (`id`, `valor_frete`, `valor_pedido`, `status`, `valor_itens`, `data_criacao`, `cep_entrega`, `endereco_entrega`, `numero_entrega`, `bairro_entrega`, `cidade_entrega`, `estado_entrega`, `id_cliente`) VALUES
(2, 14.80, 39.80, 'AGP', 25.00, '2013-10-04 18:39:41', '85901-090', 'Rua Chile', 108, 'Centro', 'Toledo', 'PR', 6);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_menu`
--

CREATE TABLE `omuz_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `omuz_menu`
--

INSERT INTO `omuz_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(101, 'mainmenu', 'Home', 'home', '', 'home', 'index.php?option=com_content&view=featured', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"featured_categories":[""],"num_leading_articles":"1","num_intro_articles":"3","num_columns":"3","num_links":"0","orderby_pri":"","orderby_sec":"front","order_date":"","multi_column_order":"1","show_pagination":"2","show_pagination_results":"1","show_noauth":"","article-allow_ratings":"","article-allow_comments":"","show_feed_link":"1","feed_summary":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_readmore":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","show_page_heading":1,"page_title":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 45, 46, 0, '*', 0),
(103, 'main', 'Loja - Olhe mais uma vez!', 'loja-olhe-mais-uma-vez', '', 'loja-olhe-mais-uma-vez', 'index.php?option=com_loja', 'component', 0, 1, 1, 10006, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 47, 48, 0, '', 1),
(104, 'olhe-mais-uma-vez', 'livros', 'livros', '', 'livros', 'index.php?option=com_loja&view=livros', 'component', 1, 1, 1, 10006, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 51, 52, 1, '*', 0),
(105, 'olhe-mais-uma-vez', 'Carrinho', 'carrinho', '', 'carrinho', 'index.php?option=com_loja&view=carrinho', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 49, 50, 0, '*', 0),
(106, 'olhe-mais-uma-vez', 'Login', 'login', '', 'login', 'index.php?option=com_users&view=login', 'component', 1, 1, 1, 25, 0, '0000-00-00 00:00:00', 0, 5, '', 0, '{"login_redirect_url":"","logindescription_show":"1","login_description":"","login_image":"","logout_redirect_url":"","logoutdescription_show":"1","logout_description":"","logout_image":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 55, 56, 0, '*', 0),
(107, 'olhe-mais-uma-vez', 'Cadastrar', 'cadastro', '', 'cadastro', 'index.php?option=com_loja&view=cadastro', 'component', 1, 1, 1, 10006, 0, '0000-00-00 00:00:00', 0, 5, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 53, 54, 0, '*', 0),
(108, 'olhe-mais-uma-vez', 'Minha Conta', 'minha-conta', '', 'minha-conta', 'index.php?option=com_loja&view=painelcontrole', 'component', 1, 1, 1, 10006, 0, '0000-00-00 00:00:00', 0, 2, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 57, 58, 0, '*', 0),
(109, 'olhe-mais-uma-vez', 'Sair', '2013-10-03-19-55-41', '', '2013-10-03-19-55-41', '/index.php/component/users/?task=user.logout', 'url', 1, 1, 1, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1}', 59, 60, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_menu_types`
--

CREATE TABLE `omuz_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `omuz_menu_types`
--

INSERT INTO `omuz_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site'),
(2, 'olhe-mais-uma-vez', 'Olhe mais uma vez', '');

-- --------------------------------------------------------

--
-- Table structure for table `omuz_messages`
--

CREATE TABLE `omuz_messages` (
...
--
-- Table structure for table `omuz_messages_cfg`
--

CREATE TABLE `omuz_messages_cfg` (
...
--
-- Table structure for table `omuz_modules`
--

CREATE TABLE `omuz_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `omuz_modules`
--

INSERT INTO `omuz_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 'Menu superior', '', '', 1, 'menu_superior', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"olhe-mais-uma-vez","base":"","startLevel":"1","endLevel":"0","showAllChildren":"1","tag_id":"","class_sfx":"","window_open":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `omuz_modules_menu`
--

CREATE TABLE `omuz_modules_menu` (
...
--
-- Dumping data for table `omuz_modules_menu`
--

INSERT INTO `omuz_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `omuz_newsfeeds`
--

CREATE TABLE `omuz_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `omuz_overrider`
--

CREATE TABLE `omuz_overrider` (
...
--
-- Table structure for table `omuz_redirect_links`
--

CREATE TABLE `omuz_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `omuz_schemas`
--

CREATE TABLE `omuz_schemas` (
...
--
-- Dumping data for table `omuz_schemas`
--

INSERT INTO `omuz_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.1.5');

-- --------------------------------------------------------

--
-- Table structure for table `omuz_session`
--

CREATE TABLE `omuz_session` (
...
--
-- Dumping data for table `omuz_session`
--

INSERT INTO `omuz_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('b47a8ed2e0a8ca02decec5a651b9c839', 0, 0, '1380924912', '__default|a:8:{s:15:"session.counter";i:67;s:19:"session.timer.start";i:1380920904;s:18:"session.timer.last";i:1380924813;s:17:"session.timer.now";i:1380924912;s:22:"session.client.browser";s:119:"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.66 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:5:"users";O:8:"stdClass":1:{s:5:"login";O:8:"stdClass":1:{s:4:"form";O:8:"stdClass":2:{s:4:"data";a:0:{}s:6:"return";s:45:"index.php?option=com_loja&view=painelcontrole";}}}s:11:"com_popstil";O:8:"stdClass":1:{s:8:"carrinho";O:8:"stdClass":1:{s:21:"dadospedidofinalizado";a:12:{s:11:"valor_frete";d:14.800000000000000710542735760100185871124267578125;s:12:"data_criacao";s:19:"2013-10-04 18:50:26";s:12:"valor_pedido";d:39.7999999999999971578290569595992565155029296875;s:6:"status";s:3:"AGP";s:11:"valor_itens";i:25;s:11:"cep_entrega";s:9:"85901-090";s:16:"endereco_entrega";s:9:"Rua Chile";s:14:"numero_entrega";s:3:"108";s:14:"bairro_entrega";s:6:"Centro";s:14:"cidade_entrega";s:6:"Toledo";s:14:"estado_entrega";s:2:"PR";s:10:"id_cliente";s:1:"6";}}}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";s:2:"11";s:4:"name";s:5:"teste";s:8:"username";s:5:"teste";s:5:"email";s:14:"testE@gmai.com";s:8:"password";s:65:"a1ce1bdcdcd0e8028bcd294a77ddad24:2KRfnb2QLY9FoiT5DlBo7xqjLWHOH1yr";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"0";s:12:"registerDate";s:19:"2013-10-04 11:59:17";s:13:"lastvisitDate";s:19:"2013-10-04 16:36:37";s:10:"activation";s:0:"";s:6:"params";s:2:"{}";s:6:"groups";a:1:{i:2;s:1:"2";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:2;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:2;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"1fc141514551bc1076d4c756bd0fc10b";}', 11, 'teste');

-- --------------------------------------------------------

--
-- Table structure for table `omuz_tags`
--

CREATE TABLE `omuz_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `omuz_tags`
--

INSERT INTO `omuz_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `omuz_template_styles`
--

CREATE TABLE `omuz_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `omuz_template_styles`
--

INSERT INTO `omuz_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'templatepadrao-olhemaisumavez', 0, '1', 'TemplatePadrao-Olhemaisumavez - Padrão', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `omuz_ucm_base`
--

CREATE TABLE `omuz_ucm_base` (
...
--
-- Table structure for table `omuz_ucm_content`
--

CREATE TABLE `omuz_ucm_content` (
...
--
-- Table structure for table `omuz_updates`
--

CREATE TABLE `omuz_updates` (
...
--
-- Dumping data for table `omuz_updates`
--

INSERT INTO `omuz_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
(1, 3, 0, 'Malay', '', 'pkg_ms-MY', 'package', '', 0, '3.1.5.2', '', 'http://update.joomla.org/language/details3/ms-MY_details.xml', ''),
...
(12, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', ''),
(13, 3, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/be-BY_details.xml', ''),
(14, 3, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/bg-BG_details.xml', ''),
(15, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', ''),
(16, 3, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/zh-CN_details.xml', ''),
(17, 3, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/hr-HR_details.xml', ''),
(18, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', ''),
(19, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', ''),
(20, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', ''),
...
(23, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', ''),
(24, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', ''),
(25, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', ''),
(26, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', ''),
(27, 3, 0, 'Kurdish Sorani', '', 'pkg_ckb-IQ', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/ckb-IQ_details.xml', ''),
(28, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', ''),
(29, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', ''),
(30, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', ''),
(31, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', ''),
(32, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.1.4.2', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', ''),
(33, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.0.2.2', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', ''),
...
(36, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.1.5.2', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', ''),
...
(43, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', ''),
(44, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sq-AL_details.xml', ''),
(45, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', ''),
(46, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', ''),
(47, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', ''),
(48, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', ''),
(49, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.0.3.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', ''),
(50, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', ''),
(51, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.1.4.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', ''),
(52, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.1.5.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '');

-- --------------------------------------------------------

--
-- Table structure for table `omuz_update_sites`
--

CREATE TABLE `omuz_update_sites` (
...
--
-- Dumping data for table `omuz_update_sites`
--

INSERT INTO `omuz_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1380912154),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1380912154),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1380912154);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_update_sites_extensions`
--

CREATE TABLE `omuz_update_sites_extensions` (
...
--
-- Dumping data for table `omuz_update_sites_extensions`
--

INSERT INTO `omuz_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(3, 10003);
...
--
-- Table structure for table `omuz_usergroups`
--

CREATE TABLE `omuz_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `omuz_usergroups`
--

INSERT INTO `omuz_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `omuz_users`
--

CREATE TABLE `omuz_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `omuz_users`
--

INSERT INTO `omuz_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(5, 'Super User', 'admin', 'luyzgarcia@gmail.com', '3782388fe06e65a37960865b0611735a:ux6BAdYHj1LSfXH9fgchOpbVKFgABwv2', 0, 1, '2013-09-27 12:20:49', '2013-10-04 18:42:31', '0', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0),
(8, 'Luiz Fernando', 'luiz', 'luiz@proiz.com.br', 'edc6c63e3e1ec59f8031085be485d0a3:dJQWytvJg2Wc6op86H0Vv6VKh5RZLPMi', 0, 0, '2013-10-02 17:55:59', '2013-10-03 19:48:57', '', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0),
(11, 'teste', 'teste', 'testE@gmai.com', 'a1ce1bdcdcd0e8028bcd294a77ddad24:2KRfnb2QLY9FoiT5DlBo7xqjLWHOH1yr', 0, 0, '2013-10-04 11:59:17', '2013-10-04 21:11:05', '', '{}', '0000-00-00 00:00:00', 0),
(13, 'novo', 'teste2', 'teste2@gmail.com', '92d322f6e825299974cba54b95d511f2:yhu1idbZ47oQUvC2RklsXWeGXdWUJF9k', 0, 0, '2013-10-04 01:02:19', '0000-00-00 00:00:00', '', '{}', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `omuz_user_notes`
--

CREATE TABLE `omuz_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `omuz_user_profiles`
--

CREATE TABLE `omuz_user_profiles` (
...
--
-- Dumping data for table `omuz_user_profiles`
--

INSERT INTO `omuz_user_profiles` (`user_id`, `profile_key`, `profile_value`, `ordering`) VALUES
(8, 'profile.address1', '""', 1),
(8, 'profile.city', '""', 2),
(8, 'profile.dob', '""', 7),
(8, 'profile.phone', '""', 5),
(8, 'profile.postal_code', '""', 4),
(8, 'profile.region', '""', 3),
(8, 'profile.spacer', '""', 6),
(11, 'profile.address1', '""', 1),
(11, 'profile.city', '""', 2),
(11, 'profile.dob', '""', 7),
(11, 'profile.phone', '""', 5),
(11, 'profile.postal_code', '""', 4),
(11, 'profile.region', '""', 3),
(11, 'profile.spacer', '""', 6);
...
--
-- Table structure for table `omuz_user_usergroup_map`
--

CREATE TABLE `omuz_user_usergroup_map` (
...
--
-- Dumping data for table `omuz_user_usergroup_map`
--

INSERT INTO `omuz_user_usergroup_map` (`user_id`, `group_id`) VALUES
(5, 8),
(8, 2),
(11, 2),
(13, 2);
...
--
-- Table structure for table `omuz_viewlevels`
--

CREATE TABLE `omuz_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `omuz_viewlevels`
--

INSERT INTO `omuz_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `omuz_weblinks`
--

CREATE TABLE `omuz_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Constraints for table `omuz_loja_itens_pedido`
--
ALTER TABLE `omuz_loja_itens_pedido`
  ADD CONSTRAINT `fk_loja_item_pedido_loja_pedido1` FOREIGN KEY (`id_pedido`) REFERENCES `omuz_loja_pedidos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `omuz_loja_livros`
--
ALTER TABLE `omuz_loja_livros`
  ADD CONSTRAINT `fk_olhemaisumavez_livros_olhemaisumavez_editoras` FOREIGN KEY (`id_editora`) REFERENCES `omuz_loja_editoras` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `omuz_loja_livros_autores`
--
ALTER TABLE `omuz_loja_livros_autores`
  ADD CONSTRAINT `fk_olhemaisumavez_livros_has_olhemaisumavez_autores_olhemaisu1` FOREIGN KEY (`id_livro`) REFERENCES `omuz_loja_livros` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_olhemaisumavez_livros_has_olhemaisumavez_autores_olhemaisu2` FOREIGN KEY (`id_autor`) REFERENCES `omuz_loja_autores` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `omuz_loja_pedidos`
--
ALTER TABLE `omuz_loja_pedidos`
  ADD CONSTRAINT `fk_loja_pedido_loja_clientes1` FOREIGN KEY (`id_cliente`) REFERENCES `omuz_loja_clientes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
