...
class UsersControllerUser extends UsersController
{
	...
	{
		JSession::checkToken('post') or $this->setRedirect(JRoute::_('index.php?option=com_users&view=login', false));;
		...
		$pedidoandamento = $app->getUserState('com_loja.pedidoandamento');
		
		if($pedidoandamento == '1') {
			$app->setUserState('com_loja.pedidoandamento', '0');
			$data['return'] = 'index.php?option=com_loja&view=carrinho';
		}else {		
			$data['return'] = 'index.php?option=com_loja&view=painelcontrole';
		}
